...
public class JournalToggle : MonoBehaviour
{
    ...
    public void ShowClosedJournal()
    {
        ...
        isJournalOpen = false;
        // Doar blocăm interacțiunile, NU blocăm timpul încă
        Time.timeScale = 1f;
        ToggleGameplayInteraction(true); // permitem interacțiunea pentru click pe imagine
    ...
    public void FlipOpen()
    {
        ...
        isJournalOpen = true;
        Time.timeScale = 0f;
        ToggleGameplayInteraction(false); // acum chiar oprim lumea
