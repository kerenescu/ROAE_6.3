...
public class JournalManager : MonoBehaviour
{
    ...
    public void FlipOpen()
    {
        ...
        ToggleGameplayInteraction(false); // 💥 OPRIRE INPUT
    }
    ...
    private void ToggleGameplayInteraction(bool enable)
    {
        ...
        if (inputScripts == null)
        {
            ...
            if (player != null)
                ...
                Debug.LogWarning("⚠️ Nu am găsit niciun GameObject cu tag Player – inputScripts rămâne null.");
        }
    ...
    {
        Debug.Log("📝 ShowPage() triggered. Page index: " + index);

        if (thoughtsPage == null) Debug.LogError("❌ thoughtsPage is NULL");
        if (flowersPage == null) Debug.LogError("❌ flowersPage is NULL");
        if (tasksPage == null) Debug.LogError("❌ tasksPage is NULL");

        if (thoughtsText == null) Debug.LogError("❌ thoughtsText is NULL");
        if (tasksText == null) Debug.LogError("❌ tasksText is NULL");
        if (flowersGrid == null) Debug.LogError("❌ flowersGrid is NULL");
        if (flowerPrefab == null) Debug.LogError("❌ flowerPrefab is NULL");
