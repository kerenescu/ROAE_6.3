...
public class TarotReadingManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Arătăm hint-ul imediat ce poate închide
        if (!spaceHintText.activeSelf)
            spaceHintText.SetActive(true);

        // Apasă SPACE sau click oriunde pentru a închide
    ...
    public void NotifyCardRevealed()
    {
        ...
        {
            // Așteptăm ca interpretarea ultimei cărți să fie închisă
            StartCoroutine(WaitForLastInterpretationThenFinalLine());
        }
    }
