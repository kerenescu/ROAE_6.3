...
public class CreativeHUD : MonoBehaviour
{
    ...
    private IEnumerator AnimateFeedback(Vector3 position, string text)
    {
        ...
        feedbackGO.transform.SetParent(transform); // se leagă de CreativeHUD
        ...
        rect.position = position + new Vector3(0, 50, 0); // puțin deasupra iconiței
        ...
        while (elapsed < duration)
        {
            ...
            rect.position += Vector3.up * Time.deltaTime * 20; // mișcare ușoară în sus
