...
public class PhoneManager : MonoBehaviour
{
    ...
    void ConfigureBubble(GameObject bubble, PhoneMessage msg)
    {
        ...
        // ↔️ Aliniere stânga/dreapta a întregului bubble
        ...
        // 🔧 Aliniere conținut interior
        Transform content = bubble.transform.Find("BubbleContent");
        if (content != null)
        {
            var layout = content.GetComponent<VerticalLayoutGroup>();
            if (layout != null)
            {
                layout.childAlignment = isFromRina ? TextAnchor.UpperRight : TextAnchor.UpperLeft;
                layout.padding = new RectOffset(10, 10, 6, 6);  // padding intern
                layout.spacing = 2;
            }
        }
    }
