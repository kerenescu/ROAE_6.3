	...
	public class HighlightEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			if (_target.brightenMaterials)
			{
				...
				_target.highlightMaterialPropertyOverride = CustomGUILayout.TextField ("Highlight material override:", _target.highlightMaterialPropertyOverride, "", "By default, the '_Color' or '_BaseColor' property will be affected. The value entered here will override that.");
			}
